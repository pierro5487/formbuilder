<template>
    <div class="form-group">
        ...
        <input type="color" class="form-control" :id="id" v-model="val" :name="name" :class="{'is-invalid':haveError}" :placeholder="placeholder" :required="required" :readOnly="readOnly">
